...
*/
(function (e) { "object" === typeof module && module.exports ? (e["default"] = e, module.exports = e) : "function" === typeof define && define.amd ? define("highcharts/highcharts-more", ["highcharts"], function (z) { e(z); e.Highcharts = z; return e }) : e("undefined" !== typeof Highcharts ? Highcharts : void 0) })(function (e) {
    ...
    e["Mixins/CenteredSeries.js"]], function (e, c, h, f, a, u) {
        function d(b, a, k) { return Math.sqrt(Math.pow(b - k[0], 2) + Math.pow(a - k[1], 2)) <= k[2] / 2 } var r = a.addEvent, n = a.extend, x = a.merge, b = a.pick, k = a.splat; e.prototype.collectionsWithUpdate.push("pane"); a = function () {
            ...
            this.options = this.chart = this.center = this.background = void 0; this.coll = "pane"; this.defaultOptions = { center: ["50%", "50%"], size: "85%", innerSize: "0%", startAngle: 0 }; this.defaultBackgroundOptions = {
                ...
                var k = "animate", l = { "class": "highcharts-pane " + (b.className || "") }; this.chart.styledMode || n(l, {
                    ...
                    function b() { var b = null !== a && a.apply(this, arguments) || this; b.data = void 0; b.points = void 0; b.options = void 0; b.yAxis = void 0; return b } u(b, a); b.prototype.translate = function () {
                        ...
                        var a = this, b = a.chart, d = a.yAxis.center, c = a.pivot, q = a.options, g = q.pivot, A = b.renderer; a.points.forEach(function (g) {
                            var d = g.graphic, c = g.shapeArgs, v = c.d, p = k(q.dial,
                                g.dial); d ? (d.animate(c), c.d = v) : g.graphic = A[g.shapeType](c).attr({ rotation: c.rotation, zIndex: 1 }).addClass("highcharts-dial").add(a.group); if (!b.styledMode) g.graphic[d ? "animate" : "attr"]({ stroke: p.borderColor || "none", "stroke-width": p.borderWidth || 0, fill: p.backgroundColor || h.neutralColor100 })
                        }); c ? c.animate({ translateX: d[0], translateY: d[1] }) : (a.pivot = A.circle(0, 0, l(g.radius, 5)).attr({ zIndex: 2 }).addClass("highcharts-pivot").translate(d[0], d[1]).add(a.group), b.styledMode || a.pivot.attr({
            ...
            var f = this && this.__extends || function () {
                ...
                function d() { var a = null !== h && h.apply(this, arguments) || this; a.options = void 0; a.series = void 0; return a } f(d, h); d.prototype.getClassName = function () {
                    var a = c.prototype.getClassName.call(this); this.isSum ?
                        a += " highcharts-sum" : this.isIntermediateSum && (a += " highcharts-intermediate-sum"); return a
            ...
            var r = c.parse, n = h.noop; c = d.addEvent; var x = d.arrayMax, b = d.arrayMin, k = d.isNumber, l = d.merge, t = d.objectEach, w = d.pick, B = d.setOptions, z = d.stableSort, F = d.wrap; ""; B({
                ...
                this.options = this.symbols = this.visible = this.ranges = this.movementX = this.maxLabel =
                    ...
                    c.bubbleItems.push(d.circle(p, f + ((r % 1 ? 1 : .5) - (g % 2 ? 0 : .5)), k).attr(t ? {} : a.bubbleStyle).addClass((t ? "highcharts-color-" + this.options.seriesIndex + " " : "") + "highcharts-bubble-legend-symbol " + (b.className || "")).add(this.legendSymbol)); c.connectors.push(d.path(d.crispLine([["M", p, r], ["L", p + h, r]], b.connectorWidth)).attr(t ? {} : a.connectorStyle).addClass((t ? "highcharts-color-" + this.options.seriesIndex + " " : "") + "highcharts-bubble-legend-connectors " + (b.connectorClassName || "")).add(this.legendSymbol)); a = d.text(this.formatLabel(a),
                        n, e + l).attr(t ? {} : a.labelStyle).addClass("highcharts-bubble-legend-labels " + (b.labels.className || "")).add(this.legendSymbol); m.push(a); a.placed = !0; a.alignAttr = { x: n, y: e + l }
